...
namespace rf2o
{
  ...
  public:
    ...
    void initPoseCallBack(const geometry_msgs::Pose::ConstPtr &new_initPose);
  };
  ...
  CLaserOdometry2DNode::CLaserOdometry2DNode() : CLaserOdometry2D()
  {
    ...
    pn.param<std::string>("init_pose_from_topic", init_pose_from_topic, "/initial_pose");
    ...
    {
      initPose_sub = n.subscribe<geometry_msgs::Pose>(init_pose_from_topic, 1, &CLaserOdometry2DNode::initPoseCallBack, this);
  ...
  void CLaserOdometry2DNode::initPoseCallBack(const geometry_msgs::Pose::ConstPtr &new_initPose)
  {
    //Initialize module on first GT pose. Else do Nothing!
    if (!GT_pose_initialized)
    {
      robot_pose = *new_initPose;
      initial_robot_pose.pose.pose.position.x = robot_pose.position.x;
      initial_robot_pose.pose.pose.position.y = robot_pose.position.y;
      initial_robot_pose.pose.pose.position.z = robot_pose.position.z;
      initial_robot_pose.pose.pose.orientation.w = robot_pose.orientation.w;
      initial_robot_pose.pose.pose.orientation.x = robot_pose.orientation.x;
      initial_robot_pose.pose.pose.orientation.y = robot_pose.orientation.y;
      initial_robot_pose.pose.pose.orientation.z = robot_pose.orientation.z;
      GT_pose_initialized = true;
    }
  }
