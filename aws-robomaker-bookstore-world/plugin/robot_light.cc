...
namespace gazebo
{
    class RobotLightPlugin : public WorldPlugin
    {
    private:
    ...
    public:
        void Load(physics::WorldPtr _world, sdf::ElementPtr _sdf) override
        {
            ...
            this->lightPub = this->gzNode->Advertise<msgs::Light>("/gazebo/default/light/modify");
            ...
            ros::SubscribeOptions so =
                ros::SubscribeOptions::create<std_msgs::Float32>(
                    "/boxer_light_toggle",
                    1,
                    boost::bind(&RobotLightPlugin::OnRosMsg, this, _1),
                    ros::VoidPtr(), &this->rosQueue);
            this->rosSub = this->rosNode->subscribe(so);

            // Spin up the queue helper thread.
            this->rosQueueThread =
                std::thread(std::bind(&RobotLightPlugin::QueueThread, this));
        }
    public:
    ...
    GZ_REGISTER_WORLD_PLUGIN(RobotLightPlugin);
} // namespace gazebo
